...
class Session : public QObject
{
    ...
    public:
        ...
        explicit Session(SessionType type = Single, QWidget* parent = 0, Session* previousSession = 0);
         ~Session();
    ...
    private:
        void setupSession(SessionType type, Session* previousSession);

        Terminal* addTerminal(QWidget* parent, Terminal *previousTerminal = 0);
